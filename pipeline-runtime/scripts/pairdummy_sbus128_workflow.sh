...
periodic_sync_enable=${CAPTURE_PERIODIC_SYNC_ENABLE}
...
gdb_marker_enable=${PIPELINE_RUNTIME_GDB_MARKER_ENABLE:-0}
gdb_marker_site=${PIPELINE_RUNTIME_GDB_MARKER_SITE:-any}
gdb_marker_segment=${PIPELINE_RUNTIME_GDB_MARKER_SEGMENT:-any}
gdb_marker_global_stage=${PIPELINE_RUNTIME_GDB_MARKER_GLOBAL_STAGE:-any}
gdb_marker_local_stage=${PIPELINE_RUNTIME_GDB_MARKER_LOCAL_STAGE:-any}
gdb_marker_subbatch=${PIPELINE_RUNTIME_GDB_MARKER_SUBBATCH:-any}
gdb_marker_manager=${PIPELINE_RUNTIME_GDB_MARKER_MANAGER:-any}
gdb_marker_tensor=${PIPELINE_RUNTIME_GDB_MARKER_TENSOR:-any}
gdb_marker_page=${PIPELINE_RUNTIME_GDB_MARKER_PAGE:-any}
gdb_marker_token=${PIPELINE_RUNTIME_GDB_MARKER_TOKEN:-any}
...
debug_preflight() {
  ...
  echo "debug_preflight_gdb_marker_enable=${PIPELINE_RUNTIME_GDB_MARKER_ENABLE:-0}"
  echo "debug_preflight_gdb_marker_site=${PIPELINE_RUNTIME_GDB_MARKER_SITE:-any}"
