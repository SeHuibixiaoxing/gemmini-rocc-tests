...
caller_pipeline_runtime_yaml_line_log_enable="${PIPELINE_RUNTIME_YAML_LINE_LOG_ENABLE-}"
...
export PIPELINE_RUNTIME_YAML_LINE_LOG_ENABLE="${PAIRDUMMY_SBUS64_YAML_LINE_LOG_ENABLE:-${caller_pipeline_runtime_yaml_line_log_enable:-0}}"
