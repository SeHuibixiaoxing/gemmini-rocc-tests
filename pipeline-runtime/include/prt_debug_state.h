...
typedef enum {
  ...
  PRT_GDB_MARKER_SITE_DMA_SUBMITWAIT_AFTER_WAIT = 25,
  PRT_GDB_MARKER_SITE_DMA_SUBMITWAIT_AFTER_CLEANUP = 26,
  PRT_GDB_MARKER_SITE_DMA_FIXED_LOAD_SUBMITWAIT_BEGIN = 27,
  PRT_GDB_MARKER_SITE_DMA_FIXED_LOAD_SUBMITWAIT_END = 28,
  PRT_GDB_MARKER_SITE_DMA_FIXED_LOAD_PAGE_ACCOUNTED = 29,
  PRT_GDB_MARKER_SITE_DMA_WAIT_AFTER_FENCE = 30,
  PRT_GDB_MARKER_SITE_DMA_WAIT_BEFORE_SHARED_FENCE = 31,
  PRT_GDB_MARKER_SITE_DMA_WAIT_AFTER_SHARED_FENCE = 32,
  PRT_GDB_MARKER_SITE_DMA_WAIT_AFTER_RELEASE = 33,
  PRT_GDB_MARKER_SITE_DMA_WAIT_AFTER_COMPLETE = 34,
  PRT_GDB_MARKER_SITE_DMA_WAIT_AFTER_TRACE_COMPLETE = 35,
