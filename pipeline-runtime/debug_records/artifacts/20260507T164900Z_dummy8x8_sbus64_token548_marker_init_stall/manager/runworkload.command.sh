...
exec > >(tee -a /home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/pairdummy-sbus64-dummy8x8-gdbserver-cfg32-nic-notrace-runworkload-20260507-161937.pane.log) 2>&1

watchdog_enabled=true
watchdog_timeout_seconds=10800
watchdog_log=/home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/pairdummy-sbus64-dummy8x8-gdbserver-cfg32-nic-notrace-runworkload-20260507-161937.watchdog.log
watchdog_pid_file=/home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/pairdummy-sbus64-dummy8x8-gdbserver-cfg32-nic-notrace-runworkload-20260507-161937.watchdog.pid
watchdog_triggered_file=/home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/pairdummy-sbus64-dummy8x8-gdbserver-cfg32-nic-notrace-runworkload-20260507-161937.watchdog.triggered
...
monitor_log=/home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/pairdummy-sbus64-dummy8x8-gdbserver-cfg32-nic-notrace-runworkload-20260507-161937.monitor.log
monitor_pid_file=/home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/pairdummy-sbus64-dummy8x8-gdbserver-cfg32-nic-notrace-runworkload-20260507-161937.monitor.pid
monitor_pid=""
...
if [[ "${watchdog_enabled}" == "true" ]]; then
  ...
  (
    ...
    if [[ -f /home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/pairdummy-sbus64-dummy8x8-gdbserver-cfg32-nic-notrace-runworkload-20260507-161937.exitcode ]]; then
      exit 0
    fi
...
PY
  ...
  if [[ -n "${monitor_script}" ]]; then
    ...
    (
      ...
      export FIRESIM_MONITOR_SESSION_NAME="pairdummy-sbus64-dummy8x8-gdbserver-cfg32-nic-notrace-runworkload-20260507-161937"
      export FIRESIM_MONITOR_EXIT_CODE_FILE=/home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/pairdummy-sbus64-dummy8x8-gdbserver-cfg32-nic-notrace-runworkload-20260507-161937.exitcode
...
echo "${status}" > /home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/pairdummy-sbus64-dummy8x8-gdbserver-cfg32-nic-notrace-runworkload-20260507-161937.exitcode
