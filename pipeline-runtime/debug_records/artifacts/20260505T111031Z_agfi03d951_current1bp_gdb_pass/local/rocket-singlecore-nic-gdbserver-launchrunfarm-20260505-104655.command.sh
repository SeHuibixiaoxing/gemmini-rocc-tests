...
exec > >(tee -a /home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/rocket-singlecore-nic-gdbserver-launchrunfarm-20260505-104655.pane.log) 2>&1
...
if [[ "${watchdog_enabled}" == "true" ]]; then
  ...
  (
    ...
    if [[ -f /home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/rocket-singlecore-nic-gdbserver-launchrunfarm-20260505-104655.exitcode ]]; then
      exit 0
    fi
...
PY
  ...
  if [[ -n "${monitor_script}" ]]; then
    ...
    (
      ...
      export FIRESIM_MONITOR_SESSION_NAME="rocket-singlecore-nic-gdbserver-launchrunfarm-20260505-104655"
      export FIRESIM_MONITOR_EXIT_CODE_FILE=/home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/rocket-singlecore-nic-gdbserver-launchrunfarm-20260505-104655.exitcode
...
echo "${status}" > /home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/rocket-singlecore-nic-gdbserver-launchrunfarm-20260505-104655.exitcode
