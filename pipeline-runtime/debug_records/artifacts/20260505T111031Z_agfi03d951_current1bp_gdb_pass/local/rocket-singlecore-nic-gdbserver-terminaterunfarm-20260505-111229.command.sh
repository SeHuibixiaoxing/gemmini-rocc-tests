...
exec > >(tee -a /home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/rocket-singlecore-nic-gdbserver-terminaterunfarm-20260505-111229.pane.log) 2>&1
...
echo "[firesim-tmux] command: firesim terminaterunfarm -c /home/ubuntu/chipyard/sims/firesim/deploy/config_runtime_f2_rocket_singlecore_nic_gdbserver_smoke_notrace_clean1bp_recovereddriver_30mhz.yaml -a /home/ubuntu/chipyard/tmp/firesim-aws-f2/hwdb/config_hwdb_f2_rocket_singlecore_nic_notrace_30mhz_agfi03d951_timingholdfixpcisreg1bp_driver.yaml -r /home/ubuntu/chipyard/sims/firesim/deploy/config_build_recipes_f2_rocket_singlecore_nic_notrace_30mhz.yaml --forceterminate"
echo "[firesim-tmux] propagated FIRESIM env vars:  "

set +e
if [[ "${watchdog_enabled}" == "true" ]]; then
  firesim terminaterunfarm -c /home/ubuntu/chipyard/sims/firesim/deploy/config_runtime_f2_rocket_singlecore_nic_gdbserver_smoke_notrace_clean1bp_recovereddriver_30mhz.yaml -a /home/ubuntu/chipyard/tmp/firesim-aws-f2/hwdb/config_hwdb_f2_rocket_singlecore_nic_notrace_30mhz_agfi03d951_timingholdfixpcisreg1bp_driver.yaml -r /home/ubuntu/chipyard/sims/firesim/deploy/config_build_recipes_f2_rocket_singlecore_nic_notrace_30mhz.yaml --forceterminate &
  firesim_pid=$!
  ...
  (
    ...
    if [[ -f /home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/rocket-singlecore-nic-gdbserver-terminaterunfarm-20260505-111229.exitcode ]]; then
      exit 0
    fi
...
PY
  ...
  if [[ -n "${monitor_script}" ]]; then
    ...
    (
      ...
      export FIRESIM_MONITOR_SESSION_NAME="rocket-singlecore-nic-gdbserver-terminaterunfarm-20260505-111229"
      export FIRESIM_MONITOR_EXIT_CODE_FILE=/home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/rocket-singlecore-nic-gdbserver-terminaterunfarm-20260505-111229.exitcode
...
echo "${status}" > /home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/rocket-singlecore-nic-gdbserver-terminaterunfarm-20260505-111229.exitcode
