...
exec > >(tee -a /home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/rocket-singlecore-nic-gdbserver-runworkload-20260505-105215.pane.log) 2>&1

watchdog_enabled=true
watchdog_timeout_seconds=10800
watchdog_log=/home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/rocket-singlecore-nic-gdbserver-runworkload-20260505-105215.watchdog.log
watchdog_pid_file=/home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/rocket-singlecore-nic-gdbserver-runworkload-20260505-105215.watchdog.pid
watchdog_triggered_file=/home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/rocket-singlecore-nic-gdbserver-runworkload-20260505-105215.watchdog.triggered
...
if [[ "${watchdog_enabled}" == "true" ]]; then
  ...
  (
    ...
    if [[ -f /home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/rocket-singlecore-nic-gdbserver-runworkload-20260505-105215.exitcode ]]; then
      exit 0
    fi
...
PY
  ...
  if [[ -n "${monitor_script}" ]]; then
    ...
    (
      ...
      export FIRESIM_MONITOR_SESSION_NAME="rocket-singlecore-nic-gdbserver-runworkload-20260505-105215"
      export FIRESIM_MONITOR_EXIT_CODE_FILE=/home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/rocket-singlecore-nic-gdbserver-runworkload-20260505-105215.exitcode
...
echo "${status}" > /home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/rocket-singlecore-nic-gdbserver-runworkload-20260505-105215.exitcode
