...
exec > >(tee -a /home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/pairdummy-sbus64-dummy8x8-gdbserver-cfg32-nic-notrace-terminaterunfarm-20260507-114645.pane.log) 2>&1
...
if [[ "${watchdog_enabled}" == "true" ]]; then
  ...
  (
    ...
    if [[ -f /home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/pairdummy-sbus64-dummy8x8-gdbserver-cfg32-nic-notrace-terminaterunfarm-20260507-114645.exitcode ]]; then
      exit 0
    fi
...
PY
  ...
  if [[ -n "${monitor_script}" ]]; then
    ...
    (
      ...
      export FIRESIM_MONITOR_SESSION_NAME="pairdummy-sbus64-dummy8x8-gdbserver-cfg32-nic-notrace-terminaterunfarm-20260507-114645"
      export FIRESIM_MONITOR_EXIT_CODE_FILE=/home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/pairdummy-sbus64-dummy8x8-gdbserver-cfg32-nic-notrace-terminaterunfarm-20260507-114645.exitcode
...
echo "${status}" > /home/ubuntu/chipyard/tmp/firesim-aws-f2/tmux/pairdummy-sbus64-dummy8x8-gdbserver-cfg32-nic-notrace-terminaterunfarm-20260507-114645.exitcode
