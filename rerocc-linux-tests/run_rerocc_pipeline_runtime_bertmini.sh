...
runner_log "runner-yaml-log-config line_log_enable=${PIPELINE_RUNTIME_YAML_LINE_LOG_ENABLE}"
...
for method in ${METHODS}; do
  ...
  echo "[bertmini] yaml line log enable=${PIPELINE_RUNTIME_YAML_LINE_LOG_ENABLE}"
