...
#define REROCC_FOCUSED_POINTWISE_EXPLICIT_TILES_ALIAS 1
#define REROCC_FOCUSED_POINTWISE_EXPLICIT_TARGET "linux-seg3-stage0-group0-pointwise-explicit-tiles"
