...
PIPELINE_RUNTIME_YAML_LINE_LOG_ENABLE="${PIPELINE_RUNTIME_YAML_LINE_LOG_ENABLE:-0}"
...
write_status() {
...

  {
    ...
    echo "yaml_line_log_enable=${PIPELINE_RUNTIME_YAML_LINE_LOG_ENABLE}"
    ...
    echo "no_dma_compute_enable=${PIPELINE_RUNTIME_NO_DMA_COMPUTE_ENABLE}"
...
echo "[firemarshal] yaml line log enable: ${PIPELINE_RUNTIME_YAML_LINE_LOG_ENABLE}"
...
echo "[firemarshal] no-dma compute enable: ${PIPELINE_RUNTIME_NO_DMA_COMPUTE_ENABLE}"
...
AUTO_POWEROFF=0 \
  ...
  PIPELINE_RUNTIME_YAML_LINE_LOG_ENABLE="${PIPELINE_RUNTIME_YAML_LINE_LOG_ENABLE}" \
