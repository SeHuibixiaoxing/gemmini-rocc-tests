...
echo "pw_b_vpage=1" >> "${BUILD_CONFIG}"
echo "pw_a_vpage=65" >> "${BUILD_CONFIG}"
echo "pw_c_vpage=129" >> "${BUILD_CONFIG}"
echo "pw_chunk_bias_vpage=0" >> "${BUILD_CONFIG}"
echo "pw_input_local_page_base=0" >> "${BUILD_CONFIG}"
echo "pw_weight_local_page_base=64" >> "${BUILD_CONFIG}"
echo "pw_bias_local_page_base=64" >> "${BUILD_CONFIG}"
echo "pw_output_local_page_base=32" >> "${BUILD_CONFIG}"
echo "pw_input_slot_offset=0" >> "${BUILD_CONFIG}"
echo "pw_weight_slot_offset=1" >> "${BUILD_CONFIG}"
